...
import { check_reply, check_reply_report } from '../middlewares/validations/boardValidation';
...
// 게시글 신고 눌렀을경우
router.post('/:board_id/report', jwt.check_access_token, BoardController.save_board_like);
