...
const FIND_USER_ALL = `SELECT user_id,user_name , phone_number , name , birthday , register , user_status, accept_date
FROM user;`;
const FIND_USER_ID = `SELECT user_id,user_name , phone_number , name , birthday , register , user_status, accept_date
FROM user
WHERE user_id = ?;`;
